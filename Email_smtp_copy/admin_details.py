...
background_img = PhotoImage(file = f"C:\\Users\\Deepanshu\\OneDrive\\Documents\\Proxlight_Designer_Export\\background.png")
...
enter_password_entry = tk.Entry(frame , bd = 2 , fg = "black" , highlightthickness= 1 , highlightbackground= "#884dff")
...
login.place(width = 100 , x=610 , y=420)
